...
async function sendContactData(contacDetails) {
    ...
    return <section className={classes.contact}>
        ...
        <form className={classes.form} onSubmit={sendMessageHandler}>
            ...
            <div className={classes.control}>
                ...
                <textarea required id='message' rows='5' value={enteredMessage} onChange={event => setEnteredMessage(event.target.value)}></textarea>
            </div>
